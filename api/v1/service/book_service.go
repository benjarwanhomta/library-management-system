...
func (s *bookService) GetSearchBookAll(title, author, category string) ([]models.Books, error) {
	bookAll, err := s.bookRepo.GetAllByTitleAuthorCategory(title, author, category)
	if err != nil {
		return nil, err
	}
